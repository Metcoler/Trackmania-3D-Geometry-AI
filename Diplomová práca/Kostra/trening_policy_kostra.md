...
Naratív kapitoly môže byť pokojne vedený ako vyšetrovanie. Nechceme hneď tvrdiť, že poznáme riešenie. Na začiatku vieme iba to, že potrebujeme funkciu, ktorá z pozorovania vyberie akciu. Postupne zisťujeme:
...
Kapitola by mala byť písaná ako logický reťazec rozhodnutí, nie ako náhodný zoznam experimentov. Každý experiment má odpovedať na otázku, ktorá vznikla v predchádzajúcej časti.
...
- či má sieť predikovať priamu akciu alebo zmenu akcie,
...
- `32x16` ako lacnejší experimentálny baseline,
- `48x24` ako silnejší kandidát pre dlhší tréning,
- väčšie siete ako referenciu alebo horný odhad kapacity,
- kombinácie aktivačných funkcií `relu,relu` a `relu,tanh`,
...
- výstupná vrstva musí rešpektovať zvolený action mode.
