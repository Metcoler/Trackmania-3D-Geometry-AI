...
# Sequential TM2D lexicographic reward sweep after the AABB-clearance lidar patch.
# Run from any directory:
#   powershell -ExecutionPolicy Bypass -File .\Experiments\run_lexicographic_sweep_aabb_lidar_fixed100.ps1

$RepoRoot = Split-Path -Parent (Split-Path -Parent $MyInvocation.MyCommand.Path)
Set-Location $RepoRoot

$Seed = 2026050306
$SweepRoot = "Experiments\runs_ga\lex_sweep_aabb_lidar_fixed100_seed_$Seed"
...
Write-Host "TM2D lexicographic sweep"
