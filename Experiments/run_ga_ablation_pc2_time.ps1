...
# PC2 ranking key: (finished, progress, -time)
#
# Run from repository root:
#   powershell -ExecutionPolicy Bypass -File .\Experiments\run_ga_ablation_pc2_time.ps1
#
...
Write-Host ""
Write-Host "Launched all PC2 ablation runs."
